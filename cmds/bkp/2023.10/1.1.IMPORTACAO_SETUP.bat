...
@chcp 1252 >nul
::DEFINIR CONSTANTES DOS PATHS DE AMBIENTE
::---------
rem Ambiente
@set VAR_PC_AUTORIZADO=PROG19-VM
set PATH_WORKSPACE=C:\_tmp\_bases\_importacao
set PATH_CTEMP=C:\_tmp\_imp
set PATH_DEV=F:\DESENVOLVIMENTO
set PATH_SCRIPTS=F:\DESENVOLVIMENTO\MODELO\SCRIPTS
set PATH_FONTES=C:\_Fontes\Importacao_DelphiXe10
set PATH_FONTES_LOCAL=F:\BACKUP\Temp\_pas\HadsTemp\Utilitario_Importador
set PATH_FB3=%ProgramFiles%\Firebird\Firebird_3_0
rem set PATH_NOVAS=I:\BasesNovas
set PATH_NOVAS=I:\IMPORTACAO
...
call:getLimpa N
set FILE_IBEXPERT=F:\BACKUP\Downloads\EXE\IBExpert_Portable\ibexpert.exe
...
set MSG_ERRORDEFAULT=Nao foi possivel fazer o Setup
set MSG_OK= Setup completado
set MSG_INICIOU= iniciando a importacao ID
::MAIN
::----------------------------------------------------------------------
		...
		if exist "!PATH_ALIAS!" (
			...
			if "!_IMP_DATA!" NEQ "NULO" (
				...
				if exist "!PATH_DATA!" (
					...
					set PATH_IMPORTACAO_INSTANCIA=!_IMP_DATA!_!VAR_AGORA!
					...
					REM set PATH_FONTE_ANTERIOR=%PATH_FONTES%\!_IMP_ANTERIOR!\UTILITARIOS
					REM set PATH_FONTE_ANTERIOR_EXE=%PATH_FONTES%\!_IMP_ANTERIOR!\_EXE
					REM set PATH_FONTE_ATUAL_EXE=%PATH_FONTES%\!_IMP_ALIAS!\_EXE
					set PATH_FONTE_ANTERIOR=%PATH_FONTES_LOCAL%
					...
					if exist "!PATH_ORIGEM_DADOS_BCK!" (
						...
						@if not exist "!PATH_ORIGEM_DADOS_FDB!" (
						...
						if "!VAR_DB_EXTENSAO!"=="BAK" (
							@copy "!VAR_FILE!" "%PATH_CTEMP%\!_IMP_ALIAS:~,4!.BAK" >nul
						)
					...
					if exist "!FILE_LIMPA!" (
						...
						if exist "!FILE_DADOSTEMP!" del "!FILE_DADOSTEMP!" >nul
						if exist "!FILE_BCK_TEMP!" del "!FILE_BCK_TEMP!" >nul
						rem if exist "!PATH_DESTINO_LIMPA_BCK!" del "!PATH_DESTINO_LIMPA_BCK!" >nul
					...
					@call "!PATH_IMP_SCRIPTS!\1.1.SETUP_PATHS.BAT" "!PATH_IMPORTACAO!\ORIGEM" "!PATH_IMPORTACAO!\DESTINO" "!_IMP_ALIAS!" "!PATH_IMPORTACAO_INSTANCIA!"
					rem Projeto_Importador
					rem --------------------------------------------------

					REM explorer "!PATH_FONTE_ATUAL!\Sistema"
					@explorer "!PATH_FONTE_ATUAL!"
					
					REM @"%FILE_IBEXPERT%" >nul
					...
					@echo ----------------------------------
					@echo /me %MSG_INICIOU% !_IMP_ALIAS:~,5!...
					@echo /me %MSG_INICIOU% !_IMP_ALIAS:~,5! |clip
					@pause>nul
					@echo /me %MSG_INICIOU% !_IMP_ALIAS:~,5! |clip
					call:ImportacaoLog
