...
@if %COMPUTERNAME% EQU %VAR_PC_AUTORIZADO% (
	...
	if "!_DE:~1,2!" EQU "C:" (
		...
		if "!_DE:~1,17!" NEQ "!PATH_WORKSPACE!\trunk\" (
			...
			echo %VAR_TAB%set _PARA="%PATH_WORKSPACE%\!BRANCH_ESCOLHIDA!\!_DE:~18!
			echo %VAR_TAB%!_PARA!
			echo.
			echo %VAR_TAB%if "!_DE:~1,17!" NEQ "!PATH_WORKSPACE!\trunk\" (
		...
		if "!_DE:~0,17!" NEQ "!PATH_WORKSPACE!\trunk\" (
			...
			echo %VAR_TAB%set _PARA="%PATH_WORKSPACE%\!BRANCH_ESCOLHIDA!\!_DE:~17!
			echo %VAR_TAB%!_PARA!
			echo.
			echo %VAR_TAB%if "!_DE:~0,17!" NEQ "!PATH_WORKSPACE!\trunk\" (
...
::SAIDAS
:EXIT
@echo Arquivo copiado... &timeout /t 5
goto:end
