...
set FILE_OLDER=%PATH_ORIGEM%\DADOS_GRADE_ITEM.FDB
set FILE_OLDER_BCK=%PATH_ORIGEM%\DADOS_GRADE_ITEM.BCK
set FILE_ZIP=%PATH_ORIGEM%\DADOS_GRADE_ITEM.ZIP
:: --------------------------------------------------------------------------------
:: SET PATH FILES ==================================================================
set USER=sysdba
set SENHA=masterkey

@echo CRIANDO GRADE_ITEM: "%IMP_NOME%"
@echo ================================================================================
@echo.
@if not exist "%FILE_ZIP%" goto CRIA_DADOS_GRADE_ITEM
	@del "%FILE_FDB%"
...
:EXIT
@echo ================================================================================
echo.&echo BASE GRADE_ITEM CRIADA !&pause>nul&goto:END
