...
set FILE_OLDER=%PATH_ORIGEM%\DADOS_GRADE.FDB
set FILE_OLDER_BCK=%PATH_ORIGEM%\DADOS_GRADE.BCK
set FILE_ZIP=%PATH_ORIGEM%\DADOS_GRADE.ZIP
:: --------------------------------------------------------------------------------
:: SET PATH FILES ==================================================================
set USER=sysdba
set SENHA=masterkey

@echo CRIANDO GRADE: "%IMP_NOME%"
@echo ================================================================================
@echo.
@if not exist "%FILE_ZIP%" goto CRIA_DADOS_GRADE
	@del "%FILE_FDB%"
...
:EXIT
@echo ================================================================================
echo.&echo BASE GRADE CRIADA !&pause>nul&goto:END
