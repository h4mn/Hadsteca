...
@set MSG_ERRORDEFAULT=Nao foi possivel fazer a publicacao
@set MSG_ERRO=Erro inesperado
@set MSG_AMBIENTE=Este script nao pode ser executado fora do ambiente
@set MSG_INICIAL=Iniciando publicacao da Base %VAR_IMPORTACAO_ID%
@set MSG_FILENOTFOUND=Arquivo %FILE_FDB% nao encontrado
...
set PATH_IMPORTADAS_MSG=[IMPORTACAO]%FILE_ZIP:~1%
@echo /me finalizou a importacao ID %VAR_IMPORTACAO_ID% - %PATH_IMPORTADAS_MSG%
@echo /me finalizou a importacao ID %VAR_IMPORTACAO_ID% - %PATH_IMPORTADAS_MSG%|clip
