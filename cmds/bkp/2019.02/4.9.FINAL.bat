...
set FILE_OLDER=%PATH_ORIGEM%\DADOS_FINAL.FDB
set FILE_OLDER_BCK=%PATH_ORIGEM%\DADOS_FINAL.BCK
set FILE_ZIP=%PATH_ORIGEM%\DADOS_FINAL.ZIP
set FILE_CLI=%PATH_ORIGEM%\DADOS_CLIENTE.ZIP
set FILE_FOR=%PATH_ORIGEM%\DADOS_FORNECEDOR.ZIP
set FILE_TRA=%PATH_ORIGEM%\DADOS_TRANSPORTADORA.ZIP
set FILE_PRO=%PATH_ORIGEM%\DADOS_PRODUTO.ZIP
set FILE_EST=%PATH_ORIGEM%\DADOS_ESTOQUE.ZIP
:: --------------------------------------------------------------------------------
:: SET PATH FILES ==================================================================
set USER=sysdba
set SENHA=masterkey

@echo CRIANDO FINAL: "%IMP_NOME%"
@echo ================================================================================
@echo.
@if not exist "%FILE_ZIP%" goto CRIA_DADOS_FINAL
	@del "%FILE_FDB%"
...
@del "%FILE_PRO%"
@del "%FILE_EST%"
echo.&echo BASE FINAL CRIADA !&pause>nul&goto:END
