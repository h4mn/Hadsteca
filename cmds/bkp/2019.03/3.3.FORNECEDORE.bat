...
set FILE_OLDER=%PATH_ORIGEM%\DADOS_FORNECEDOR.FDB
set FILE_OLDER_BCK=%PATH_ORIGEM%\DADOS_FORNECEDOR.BCK
set FILE_ZIP=%PATH_ORIGEM%\DADOS_FORNECEDOR.ZIP
:: --------------------------------------------------------------------------------
:: SET PATH FILES ==================================================================
set USER=sysdba
set SENHA=masterkey

@echo CRIANDO FORNECEDOR: "%IMP_NOME%"
@echo ================================================================================
@echo.
@if not exist "%FILE_ZIP%" goto CRIA_DADOS_FORNECEDOR
	@del "%FILE_FDB%"
...
:EXIT
@echo ================================================================================
echo.&echo BASE FORNECEDOR CRIADA !&pause>nul&goto:END
