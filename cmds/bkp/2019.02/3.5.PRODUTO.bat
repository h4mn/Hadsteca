...
set FILE_OLDER=%PATH_ORIGEM%\DADOS_PRODUTO.FDB
set FILE_OLDER_BCK=%PATH_ORIGEM%\DADOS_PRODUTO.BCK
set FILE_ZIP=%PATH_ORIGEM%\DADOS_PRODUTO.ZIP
:: --------------------------------------------------------------------------------
:: SET PATH FILES ==================================================================
set USER=sysdba
set SENHA=masterkey

@echo CRIANDO PRODUTO: "%IMP_NOME%"
@echo ================================================================================
@echo.
@if not exist "%FILE_ZIP%" goto CRIA_DADOS_PRODUTO
	@del "%FILE_FDB%"
...
:EXIT
@echo ================================================================================
echo.&echo BASE PRODUTO CRIADA !&pause>nul&goto:END
