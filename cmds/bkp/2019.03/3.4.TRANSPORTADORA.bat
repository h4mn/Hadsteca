...
set FILE_OLDER=%PATH_ORIGEM%\DADOS_TRANSPORTADORA.FDB
set FILE_OLDER_BCK=%PATH_ORIGEM%\DADOS_TRANSPORTADORA.BCK
set FILE_ZIP=%PATH_ORIGEM%\DADOS_TRANSPORTADORA.ZIP
:: --------------------------------------------------------------------------------
:: SET PATH FILES ==================================================================
set USER=sysdba
set SENHA=masterkey

@echo CRIANDO TRANSPORTADORA: "%IMP_NOME%"
@echo ================================================================================
@echo.
@if not exist "%FILE_ZIP%" goto CRIA_DADOS_TRANSPORTADORA
	@del "%FILE_FDB%"
...
:EXIT
@echo ================================================================================
echo.&echo BASE TRANSPORTADORA CRIADA !&pause>nul&goto:END
